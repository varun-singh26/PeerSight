...
class Form(models.Model):
    ...
    course = models.ForeignKey('courses.Course', on_delete=models.CASCADE, related_name='forms', null=True, blank=True)
    creator = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.CASCADE)
    teams = models.ManyToManyField('courses.Team', related_name='forms', blank=True)
